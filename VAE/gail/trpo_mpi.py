from common import explained_variance, zipsame, fmt_row
...
def traj_segment_generator(pi, env, discriminator, embedding ,horizon, stochastic):
    ...
    while True:
        ...
        rew = discriminator.get_reward(ob, embedding)
...
def learn(env, policy_func, discriminator, expert_dataset, embedding_z,
    ...
    # ----------------------------------------
    seg_gen = traj_segment_generator(pi, env, discriminator, embedding=embedding_z ,timesteps_per_batch = timesteps_per_batch, stochastic=True)
